...
from .views import (me_view, login_view, save_expo_push_token, register_user, chat_users_list,
                    ...
                    match_participation_view, club_payment_settings_detail, save_nordigen_connection,create_requisition,
...
urlpatterns = [
    ...
    path('save-nordigen-connection/', save_nordigen_connection),
    path("nordigen/create-requisition/", create_requisition, name="create_requisition"),
